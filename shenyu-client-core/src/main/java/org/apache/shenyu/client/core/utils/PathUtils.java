...
public final class PathUtils {
    ...
    public static String decoratorPath(final String contextPath) {
        return StringUtils.contains(contextPath, Constants.URI_SUFFIX) ? contextPath : contextPath + Constants.URI_SUFFIX;
    }
    ...
    public static String decoratorPathWithSlash(final String contextPath) {
        return StringUtils.endsWith(contextPath, Constants.URI_SLASH_SUFFIX) ? contextPath : contextPath + Constants.URI_SLASH_SUFFIX;
    }
