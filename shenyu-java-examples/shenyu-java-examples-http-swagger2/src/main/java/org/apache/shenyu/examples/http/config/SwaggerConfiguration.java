...
public class SwaggerConfiguration {
    ...
    private static final String TITLE = "shenyu-java-examples-java-http-swagger2 API";

    private static final String DESCRIPTION = "shenyu-java-examples-java-http-swagger2 API";
